...
export function EyeOffIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
            <path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.522 1 1 0 0 1 0 .804 10.742 10.742 0 0 1-3.176 4.091" />
            <path d="M14.121 14.121A3 3 0 1 1 9.88 9.88" />
            <path d="M2 2l20 20" />
            <path d="M6.505 8.505A10.718 10.718 0 0 0 2.06 11.6a1 1 0 0 0 0 .8 10.743 10.743 0 0 0 11.433 6.524" />
        </svg>
    );
}
...
export function BookIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="24" height="24" viewBox="0 0 24 24" style={{ color: 'rgb(74, 85, 101)', opacity: 1, transform: 'rotate(0deg)' }} {...props}>
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 19V5a3 3 0 0 1 3-3h13v14m0 0v6H7a1 1 0 0 1 0-6Z"></path>
        </svg>
    );
}
...
export function PersonIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="24" height="24" viewBox="0 0 24 24" style={{ color: 'rgb(74, 85, 101)', opacity: 1, transform: 'rotate(0deg)' }} {...props}>
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 20.75a1 1 0 0 0 1-1v-1.246c.004-2.806-3.974-5.004-8-5.004s-8 2.198-8 5.004v1.246a1 1 0 0 0 1 1zM15.604 6.854a3.604 3.604 0 1 1-7.208 0a3.604 3.604 0 0 1 7.208 0"></path>
        </svg>
    );
}
...
export function MonitorIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="24" height="24" viewBox="0 0 24 24" style={{ opacity: 1, transform: 'rotate(0deg)' }} {...props}>
            <path fill="currentColor" d="M3.5 18H11v2H8v2h8v-2h-3v-2h7.5c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5h-17C2.67 3 2 3.67 2 4.5v12c0 .83.67 1.5 1.5 1.5M4 5h16v11H4z"></path>
        </svg>
    );
}
...
export function FireIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="64" height="64" viewBox="0 0 24 24" style={{color: '#3A76F5', opacity: 1, transform: 'rotate(0deg)' }} {...props}><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
            <path d="M12 22c-4.97 0-9-2.582-9-7v-.088C3 12.794 4.338 11.1 6.375 10c1.949-1.052 3.101-2.99 2.813-5l-.563-3l2.086.795c3.757 1.43 6.886 3.912 8.914 7.066A8.5 8.5 0 0 1 21 14.464V15c0 1.562-.504 2.895-1.375 3.965"></path><path d="M12 22c-1.657 0-3-1.433-3-3.2c0-1.4 1.016-2.521 1.91-3.548L12 14l1.09 1.252C13.984 16.28 15 17.4 15 18.8c0 1.767-1.343 3.2-3 3.2"></path></g>
        </svg>
    )
}